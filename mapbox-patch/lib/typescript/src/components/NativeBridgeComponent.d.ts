...
declare const NativeBridgeComponent: <Props extends object, BaseComponent extends new (...ags: any[]) => React.Component<Props>>(Base: BaseComponent, turboModule: TurboModule) => {
    new (...args: any[]): {
