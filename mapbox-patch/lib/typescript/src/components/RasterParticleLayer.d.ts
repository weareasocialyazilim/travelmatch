...
import type { FilterExpression, RasterParticleLayerStyleProps } from '../utils/MapboxStyles';
 ...
 */
declare class RasterParticleLayer extends AbstractLayer<Props, NativeTypeProps> {
    static defaultProps: {
        sourceID: any;
    };
...
//# sourceMappingURL=RasterParticleLayer.d.ts.map