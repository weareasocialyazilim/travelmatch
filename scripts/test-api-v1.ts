...
async function runAllTests() {
  ...
  if (!testEmail || !testPassword) {
    ...
    // deepcode ignore NoHardcodedPasswords: Test data for negative authentication test
    const invalidTestCredential = Buffer.from(
    ...
    await testEndpoint('Login with invalid credentials', {
      ...
      body: {
        email: testEmail,
        credential: invalidTestCredential, // Encoded test credential for negative test
      },
      expectedStatus: 401,
    });
  }
