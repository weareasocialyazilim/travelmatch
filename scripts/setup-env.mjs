  ...
  mobile: {
    ...
    required: [
      ...
      },
      {
        ...
        desc: 'Supabase Anonymous Key (safe to expose)',
        example: 'eyJhbGci...',
      },
    ],
    optional: [
      ...
      {
        key: 'EXPO_PUBLIC_PAYTR_MERCHANT_ID',
        desc: 'PayTR Merchant ID',
        example: 'xxxxx',
      },
    ],
  },
    ...
    optional: [
      {
        ...
        desc: 'Supabase CLI Access Token',
        example: 'sbp_xxxxx',
      },
      {
      ...
      },
      {
        ...
        desc: 'PayTR Merchant Key (SERVER ONLY)',
        example: 'xxxxx',
      },
      {
        key: 'PAYTR_MERCHANT_SALT',
        desc: 'PayTR Merchant Salt',
        example: 'xxxxx',
      },
    ],
  },
