...
REPO="weareasocialyazilim/travelmatch"

echo "🔐 Updating GitHub Secrets for Infisical (new workspace)"
echo "=================================================="
echo ""
echo "Machine Identity: GitHub Actions TravelMatch"
...
echo "2. Click: GitHub Actions TravelMatch > Universal Auth > Add Client Secret"
