...
-- Usage: supabase db reset && psql -f supabase/seed-production-ready.sql
...
VALUES
  ...
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', '44444444-4444-4444-4444-444444444444',
   ...
   ARRAY[], ARRAY['art', 'culture', 'free'], NOW() - INTERVAL '1 day'),
  ...
  ('ffffffff-ffff-ffff-ffff-ffffffffffff', '22222222-2222-2222-2222-222222222222',
   ...
   ARRAY[], ARRAY['temple', 'culture'], NOW() - INTERVAL '7 days'),

  -- Draft moment (unpublished)
  ('gggggggg-gggg-gggg-gggg-gggggggggggg', '33333333-3333-3333-3333-333333333333',
   'Draft Flamenco Show',
   'Not yet published',
   'art', 'Seville, Spain', NOW() + INTERVAL '30 days', 40.00, 'EUR', 'draft',
   ARRAY[], ARRAY['flamenco', 'dance'], NOW());
