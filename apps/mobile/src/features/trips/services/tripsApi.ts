...
export const tripsApi = {
  ...
  update: async (id: string, updates: UpdateTripDto) => {
    ...
    if (error) throw error;
    if (!data) throw new Error('Trip not found or you do not have permission to update it');
    return data;
  },
  ...
  delete: async (id: string) => {
    ...
    if (error) throw error;
    if (!data) throw new Error('Trip not found or you do not have permission to delete it');
  },
