...
const MOCK_CHATS: InboxChat[] = [
  ...
  },
  {
    ...
    moment: {
      id: 'm2',
      title: 'Sunset Dinner',
      image: 'https://images.unsplash.com/photo-1514362545857-3bc16549766b?q=80&w=200',
      emoji: '🌅',
    },
  ...
  },
  {
    ...
    moment: {
      id: 'm3',
      title: 'Jazz Night',
      image: 'https://images.unsplash.com/photo-1514525253440-b393452e8d26?q=80&w=200',
      emoji: '🎷',
    },
  ...
  },
  {
    ...
    moment: {
      id: 'm4',
      title: 'Morning Yoga',
      image: 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?q=80&w=200',
      emoji: '🧘',
    },
...
const MOCK_REQUESTS: InboxChat[] = [
  {
    ...
    moment: {
      ...
      image: 'https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?q=80&w=200',
      emoji: '🥂',
    },
  ...
  },
  {
    ...
    moment: {
      ...
      image: 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?q=80&w=200',
      emoji: '🎨',
    },
    ...
    () => (
      <Animated.View entering={FadeIn.delay(300)} style={styles.emptyContainer}>
        ...
        {activeTab === 'active' && (
          ...
          >
            <LinearGradient
              colors={[VIBE_ROOM_COLORS.neon.amber, VIBE_ROOM_COLORS.neon.magenta]}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
