      ...
      >
        <View style={styles.backdrop}>
          <Animated.View style={[styles.container, animatedStyle]}>
            ...
            <Text style={styles.title}>Hediyeni Gönder</Text>
            <Text style={styles.message}>
              <Text style={styles.amount}>${formattedAmount}</Text> tutarında
              {'\n'}
              <Text style={styles.recipient}>{recipientName}</Text>'a hediye
              gönder
              {'\n'}ve bağ kurma şansını yakala?
            </Text>
