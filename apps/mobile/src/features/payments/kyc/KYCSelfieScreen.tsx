...
const ScanRing: React.FC<ScanRingProps> = ({ index, isScanning, isSuccess }) => {
...
const FaceOval: React.FC<{ scanState: ScanState }> = ({ scanState }) => {
  ...
  const borderColor = scanState === 'success'
  ...
  return (
    <Animated.View style={[styles.faceOvalContainer, ovalStyle]}>
      ...
      <View style={[styles.faceOval, { borderColor }]}>
        ...
        {/* Corner markers */}
        <View style={[styles.cornerMarker, styles.cornerTopLeft, { borderColor }]} />
        <View style={[styles.cornerMarker, styles.cornerTopRight, { borderColor }]} />
        <View style={[styles.cornerMarker, styles.cornerBottomLeft, { borderColor }]} />
        <View style={[styles.cornerMarker, styles.cornerBottomRight, { borderColor }]} />
      </View>
    </Animated.View>
  );
};
      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
            ...
            >
              <View style={styles.instructionRow}>
                <View style={styles.instructionIcon}>
                  <Ionicons name="sunny-outline" size={18} color={KYC_COLORS.neon.amber} />
                </View>
                <Text style={styles.instructionText}>İyi aydınlatılmış bir ortam</Text>
              </View>
              <View style={styles.instructionRow}>
                <View style={styles.instructionIcon}>
                  <Ionicons name="glasses-outline" size={18} color={KYC_COLORS.neon.violet} />
                </View>
                <Text style={styles.instructionText}>Gözlük veya şapka çıkarın</Text>
              </View>
              <View style={styles.instructionRow}>
                <View style={styles.instructionIcon}>
                  <Ionicons name="happy-outline" size={18} color={KYC_COLORS.neon.lime} />
                </View>
                <Text style={styles.instructionText}>Doğal ifade ile bakın</Text>
              </View>
            </Animated.View>
          )}
        </View>
        ...
        >
          <Animated.View style={buttonAnimatedStyle}>
            <TouchableOpacity
              onPress={scanState === 'success' ? handleContinue : startScan}
...
const ScanningDot: React.FC<{ index: number }> = ({ index }) => {
  ...
  return (
    <Animated.View style={[styles.scanDot, dotStyle]} />
  );
};
