/**
 * TravelMatch Awwwards Design System 2026 - Welcome Screen V2
 *
...
import { COLORS_V2, GRADIENTS_V2, PALETTE } from '../../../constants/colors-v2';
import { TYPE_SCALE } from '../../../constants/typography-v2';
import { SPRINGS, TIMINGS } from '../../../hooks/useAnimationsV2';
...
// MAIN COMPONENT
// ============================================
export const WelcomeScreenV2: React.FC<WelcomeScreenV2Props> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      {/* Ambient Background */}
      <LinearGradient
        colors={[COLORS_V2.bg.primary, COLORS_V2.bg.tertiary]}
...
const styles = StyleSheet.create({
  ...
  dividerLine: {
    flex: 1,
    height: 1,
    backgroundColor: COLORS_V2.text.muted,
    opacity: 0.3,
  },
  dividerText: {
