  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.para}>
          You agree to treat all users with respect. Harassment, hate speech,
          and fraudulent activities will result in an immediate ban.
        </Text>

        <Text style={styles.section}>3. Payments & Refunds</Text>
        <Text style={styles.para}>
          All payments are held in escrow. Refunds are available up to 24 hours
          before the scheduled moment. After that, payments are non-refundable.
        </Text>

        <Text style={styles.section}>4. Safety</Text>
        <Text style={styles.para}>
          While we verify users, you are responsible for your own safety. Please
          read our Safety Tips section before meeting anyone.
        </Text>
