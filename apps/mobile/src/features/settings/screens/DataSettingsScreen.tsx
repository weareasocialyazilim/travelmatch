...
export const DataSettingsScreen = ({ navigation }: any) => {
  ...
  const handleClearCache = () => {
    Alert.alert(
      "Clear Cache?",
      "This will free up 145 MB. No personal data will be deleted.",
      [
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
  textCol: { flex: 1, marginRight: 20 },
  label: { color: 'white', fontSize: 16, fontWeight: '500', marginBottom: 4 },
  desc: { color: '#666', fontSize: 13 },
  storageCard: { backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 16, padding: 20 },
  ...
  clearBtn: { marginTop: 20, alignItems: 'center', padding: 14, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 12 },
