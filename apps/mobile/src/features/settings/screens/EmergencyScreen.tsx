...
export const EmergencyScreen: React.FC<EmergencyScreenProps> = ({ navigation }) => {
  ...
  const handlePressOut = () => {
    ...
    Alert.alert("SOS Triggered", "Your location has been sent to emergency contacts.");
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.desc}>Hold the button for 3 seconds to share your live location with trusted contacts and support.</Text>
      ...
      <Animated.View style={[styles.btnContainer, animatedStyle]}>
        ...
        >
          <LinearGradient
            ...
            style={styles.sosBtn}
          >
            <MaterialCommunityIcons name="alert-octagram" size={64} color="white" />
