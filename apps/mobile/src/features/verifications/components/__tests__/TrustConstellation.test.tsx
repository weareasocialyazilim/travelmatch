...
import { DEFAULT_MILESTONES, type TrustMilestone } from '@/constants/ceremony';
...
jest.mock('react-native-svg', () => {
  ...
  return {
    ...
    Defs: ({ children }: any) =>
      React.createElement(View, { testID: 'defs' }, children),
    RadialGradient: ({ children }: any) =>
      React.createElement(View, { testID: 'radial-gradient' }, children),
    Stop: (props: any) =>
      React.createElement(View, { ...props, testID: 'stop' }),
    G: ({ children }: any) =>
      React.createElement(View, { testID: 'g' }, children),
  };
});
...
describe('TrustConstellation Component', () => {
  ...
  describe('Accessibility', () => {
    ...
    it('unverified milestones have correct accessibility hint', () => {
      ...
      expect(
        getByLabelText(/Email Doğrulandı.*Henüz doğrulanmadı/),
      ).toBeTruthy();
    });
  });
