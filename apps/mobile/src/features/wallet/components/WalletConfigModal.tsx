...
export const WalletConfigModal = ({
  ...
  const [isDefaultPayment, setIsDefaultPayment] = useState(
          ...
          <View style={styles.settingsSection}>
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                trackColor={{
                  false: COLORS.softGray,
                  true: COLORS.brand.primaryLight,
                }}
                thumbColor={
                  isDefaultPayment ? COLORS.brand.primary : COLORS.utility.white
                }
              />
            </View>
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                thumbColor={
                  requireAuth ? COLORS.brand.primary : COLORS.utility.white
                }
              />
            </View>
