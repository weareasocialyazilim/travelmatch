 ...
 */
export const usePressAnimationV2 = (options?: {
  scaleDown?: number;
  haptic?: boolean;
}) => {
 ...
 */
export const useEntranceAnimationV2 = (options?: {
  delay?: number;
 ...
 */
export const useParallaxV2 = (scrollY: SharedValue<number>, options?: {
 ...
 */
export const useFloatingAnimationV2 = (options?: {
  distance?: number;
  duration?: number;
}) => {
 ...
 */
export const useSkeletonAnimationV2 = () => {
