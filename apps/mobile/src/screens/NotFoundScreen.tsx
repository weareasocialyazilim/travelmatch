  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.desc}>
        The moment you are looking for might have expired, been deleted, or never existed in this timeline.
      </Text>
...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: COLORS.brand.primary, paddingHorizontal: 32, paddingVertical: 16, borderRadius: 30 },
