...
import { MomentAuthenticator, AuthenticationResult } from '../MomentAuthenticator';
...
describe('MomentAuthenticator Component', () => {
  ...
  describe('Result Views', () => {
    ...
    it('shows suggestions on rejection', async () => {
      ...
      await waitFor(() => {
        ...
        expect(getByText(/Try taking a photo with visible landmarks/)).toBeTruthy();
      });
    });
  ...
  describe('Edge Cases', () => {
    it('handles empty mediaUrls array gracefully', () => {
      ...
      expect(() =>
        render(<MomentAuthenticator {...propsWithEmptyMedia} testID="authenticator" />)
      ).not.toThrow();
    });
    ...
    it('handles undefined location', () => {
      ...
      const { getByTestId } = render(
        <MomentAuthenticator {...propsWithoutLocation} testID="authenticator" />
      );
      expect(getByTestId('authenticator')).toBeTruthy();
    });
    ...
    it('handles undefined expectedMoment.location', () => {
      ...
      const { getByTestId } = render(
        <MomentAuthenticator {...propsWithoutMomentLocation} testID="authenticator" />
      );
      expect(getByTestId('authenticator')).toBeTruthy();
    });
