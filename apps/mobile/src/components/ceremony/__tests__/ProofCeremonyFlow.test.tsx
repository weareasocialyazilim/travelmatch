...
jest.mock('react-native-reanimated', () => {
  ...
  return {
    ...
    FadeIn: { delay: jest.fn(() => ({ entering: 'fade-in' })) },
    FadeOut: { entering: 'fade-out' },
    SlideInRight: { entering: 'slide-in-right' },
    SlideOutLeft: { exiting: 'slide-out-left' },
    ZoomIn: { entering: 'zoom-in' },
  };
});
...
jest.mock('react-native-confetti-cannon', () => {
  ...
  return ({ children, ...props }: any) =>
    React.createElement(View, { testID: 'confetti-cannon', ...props }, children);
});
...
jest.mock('../SunsetClock', () => ({
  SunsetClock: ({ testID, ...props }: any) => {
    ...
    return React.createElement(View, { testID: testID || 'sunset-clock' },
...
jest.mock('../MomentAuthenticator', () => ({
  MomentAuthenticator: ({ onResult, onCancel, testID }: any) => {
    ...
    return React.createElement(View, { testID: testID || 'moment-authenticator' },
...
jest.mock('../ThankYouCardCreator', () => ({
  ThankYouCardCreator: ({ onComplete, onSkip, recipientName, testID }: any) => {
    const React = require('react');
    const { View, Text, TouchableOpacity } = require('react-native');
    return React.createElement(View, { testID: testID || 'thank-you-card-creator' },
...
jest.mock('../MemoryCard', () => ({
  MemoryCard: ({ gift, testID }: any) => {
    const React = require('react');
    const { View, Text } = require('react-native');
    return React.createElement(View, { testID: testID || 'memory-card' },
...
jest.mock('../SacredMoments', () => ({
  SacredMoments: ({ children, testID }: any) => {
    const React = require('react');
    const { View } = require('react-native');
    return React.createElement(View, { testID: testID || 'sacred-moments' }, children);
  },
}));
...
jest.mock('../CeremonyProgress', () => ({
  CeremonyProgress: ({ currentStep, testID }: any) => {
    const React = require('react');
    const { View, Text } = require('react-native');
    return React.createElement(View, { testID: testID || 'ceremony-progress' },
