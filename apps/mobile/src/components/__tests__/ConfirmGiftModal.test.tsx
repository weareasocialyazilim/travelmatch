...
describe('ConfirmGiftModal', () => {
  ...
  describe('Rendering', () => {
    ...
    it('displays formatted amount with 2 decimal places', () => {
      const { getByText } = render(
        <ConfirmGiftModal {...defaultProps} amount={10} />,
      );
  ...
  describe('Amount Formatting', () => {
    it('formats whole numbers with decimals', () => {
      const { getByText } = render(
        <ConfirmGiftModal {...defaultProps} amount={50} />,
      );
    ...
    it('formats cents correctly', () => {
      const { getByText } = render(
        <ConfirmGiftModal {...defaultProps} amount={0.99} />,
      );
    ...
    it('formats large amounts', () => {
      const { getByText } = render(
        <ConfirmGiftModal {...defaultProps} amount={999.99} />,
      );
    ...
    it('formats amounts with trailing zeros', () => {
      const { getByText } = render(
        <ConfirmGiftModal {...defaultProps} amount={25.5} />,
      );
    ...
    it('handles zero amount', () => {
      const { getByText } = render(
        <ConfirmGiftModal {...defaultProps} amount={0} />,
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('handles very small amounts', () => {
      const { getByText } = render(
        <ConfirmGiftModal {...defaultProps} amount={0.01} />,
      );
