...
describe('DeleteMomentDialog', () => {
  ...
  describe('Rendering', () => {
    ...
    it('displays restore location hint', () => {
      const { getByText } = render(<DeleteMomentDialog {...defaultProps} />);
      
      expect(getByText(/You can restore this from Profile → Deleted Moments/)).toBeTruthy();
    });
  });
  ...
  describe('User Interactions', () => {
    ...
    it('calls onConfirm before onClose when Delete is pressed', () => {
      ...
      const { getByText } = render(
        <DeleteMomentDialog {...defaultProps} onConfirm={onConfirm} onClose={onClose} />
      );
    ...
    it('calls onClose when close X button is pressed', () => {
      const { UNSAFE_getAllByType } = render(<DeleteMomentDialog {...defaultProps} />);
    ...
    it('calls onClose when modal backdrop is requested to close', () => {
      const { UNSAFE_getByType } = render(<DeleteMomentDialog {...defaultProps} />);
      const modal = UNSAFE_getByType(require('react-native').Modal);
  ...
  describe('Modal Properties', () => {
    ...
    it('sets visible prop correctly', () => {
      const { UNSAFE_getByType, rerender } = render(<DeleteMomentDialog {...defaultProps} />);
