...
describe('UnblockUserBottomSheet', () => {
  ...
  describe('Rendering', () => {
    it('renders when visible is true', () => {
      const { getByText } = render(
        <UnblockUserBottomSheet {...defaultProps} />,
      );
    ...
    it('does not render when visible is false', () => {
      const { UNSAFE_queryByType } = render(
        <UnblockUserBottomSheet {...defaultProps} visible={false} />,
      );
    ...
    it('renders user name in title', () => {
      const { getByText } = render(
        <UnblockUserBottomSheet {...defaultProps} userName="Maria" />,
      );
    ...
    it('renders description text', () => {
      ...
      expect(
        getByText(/You will be able to see their travel moments/),
      ).toBeTruthy();
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('handles very long user names', () => {
      ...
      const { getByText } = render(
        <UnblockUserBottomSheet {...defaultProps} userName={longName} />,
      );
    ...
    it('handles user names with special characters', () => {
      ...
      const { getByText } = render(
        <UnblockUserBottomSheet {...defaultProps} userName={specialName} />,
      );
    ...
    it('handles empty user name gracefully', () => {
      const { getByText } = render(
        <UnblockUserBottomSheet {...defaultProps} userName="" />,
      );
      expect(getByText('Unblock ?')).toBeTruthy();
    });
  });
