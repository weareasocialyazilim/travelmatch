...
describe('SetPriceBottomSheet', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders custom amount input field', () => {
      const { UNSAFE_getByType } = render(<SetPriceBottomSheet {...defaultProps} />);
    ...
    it('renders currency icon', () => {
      const { UNSAFE_getAllByType } = render(<SetPriceBottomSheet {...defaultProps} />);
      ...
      const currencyIcon = icons.find((icon: any) => icon.props.name === 'currency-usd');
  ...
  describe('User Interactions', () => {
    ...
    it('calls onSetPrice with custom amount', () => {
      const { UNSAFE_getByType, getByText } = render(<SetPriceBottomSheet {...defaultProps} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('handles whitespace in custom amount', () => {
      ...
      expect(mockOnSetPrice).toHaveBeenCalledWith(25.50);
    });
