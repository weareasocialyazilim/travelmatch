...
describe('RequestAdditionalProofBottomSheet', () => {
  ...
  describe('Rendering', () => {
    it('renders when visible', () => {
      const { getByText } = render(<RequestAdditionalProofBottomSheet {...defaultProps} />);
    ...
    it('renders close button', () => {
      const component = render(<RequestAdditionalProofBottomSheet {...defaultProps} />);
    ...
    it('renders text input with placeholder', () => {
      ...
      expect(input.props.placeholder).toBe("Tell them what you need to confirm the moment. e.g., 'Could you please upload a photo of the ticket stub?'");
    });
    ...
    it('does not render when not visible', () => {
      const { toJSON } = render(<RequestAdditionalProofBottomSheet {...defaultProps} visible={false} />);
      const modal = toJSON();
  ...
  describe('Modal Properties', () => {
    it('sets modal as transparent', () => {
      const { toJSON } = render(<RequestAdditionalProofBottomSheet {...defaultProps} />);
      const modal = toJSON();
  ...
  describe('Edge Cases', () => {
    ...
    it('handles newlines and formatting', () => {
      ...
      const formattedText = 'Please upload:\n\n1. Front of ticket\n2. Back of ticket';
