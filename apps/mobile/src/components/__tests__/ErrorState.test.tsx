...
describe('ErrorState', () => {
  ...
  describe('Custom Styling', () => {
    it('should apply custom style', () => {
      ...
      render(<ErrorState style={customStyle} />);
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle long error messages', () => {
      const longMessage =
        'This is a very long error message that should still render correctly even though it contains many words and might wrap to multiple lines';
