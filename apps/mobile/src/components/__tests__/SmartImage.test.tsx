...
describe('SmartImage', () => {
  ...
  describe('Callbacks', () => {
    ...
    it('does not call onError on fallback retry', () => {
      const mockOnError = jest.fn();
      const { UNSAFE_getByType } = render(
        <SmartImage uri={mockUri} fallbackUri={mockFallbackUri} onError={mockOnError} />
      );
  ...
  describe('Edge Cases', () => {
    it('handles undefined URI gracefully', () => {
      const { UNSAFE_getByType } = render(<SmartImage uri={undefined as any} />);
...
describe('AvatarImage', () => {
  ...
  describe('Rendering', () => {
    it('renders SmartImage when URI is provided', () => {
      const { UNSAFE_getByType } = render(<AvatarImage uri={mockUri} name="John" />);
    ...
    it('generates consistent color from name', () => {
      ...
      const fallbackView = views.find(v => v.props.style?.some?.((s: any) => s?.backgroundColor));
  ...
  describe('Edge Cases', () => {
    ...
    it('handles very long name', () => {
      ...
      const { UNSAFE_getByType } = render(<AvatarImage uri="" name={longName} />);
    ...
    it('icon size scales with avatar size', () => {
      const { UNSAFE_getByType } = render(<AvatarImage uri="" name="John" size={100} />);
