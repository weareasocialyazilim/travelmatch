...
describe('CurrencySelectionBottomSheet', () => {
  ...
  describe('Rendering', () => {
    it('renders correctly when visible', () => {
      const { getByText } = render(<CurrencySelectionBottomSheet {...defaultProps} />);
    ...
    it('renders search input', () => {
      const { UNSAFE_getByType } = render(<CurrencySelectionBottomSheet {...defaultProps} />);
    ...
    it('renders search icon', () => {
      const { UNSAFE_getAllByType } = render(<CurrencySelectionBottomSheet {...defaultProps} />);
  ...
  describe('Selection State', () => {
    ...
    it('uses provided selected currency', () => {
      const { getByText } = render(
        <CurrencySelectionBottomSheet {...defaultProps} selectedCurrency="EUR" />
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('confirms without changing selection', () => {
      const { getByText } = render(
        <CurrencySelectionBottomSheet {...defaultProps} selectedCurrency="TRY" />
      );
