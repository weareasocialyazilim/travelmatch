...
import { LanguageSelectionBottomSheet } from '../../features/settings/components/LanguageSelectionBottomSheet';
...
describe('LanguageSelectionBottomSheet', () => {
  ...
  describe('Rendering', () => {
    it('renders correctly when visible', () => {
      const { getByText } = render(
        <LanguageSelectionBottomSheet {...defaultProps} />,
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('renders correctly when reopened', () => {
      ...
      rerender(
        <LanguageSelectionBottomSheet {...defaultProps} visible={true} />,
      );
