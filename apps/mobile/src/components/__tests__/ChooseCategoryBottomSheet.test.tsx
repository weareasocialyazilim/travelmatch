...
describe('ChooseCategoryBottomSheet', () => {
  ...
  describe('Rendering', () => {
    it('renders correctly when visible', () => {
      const { getByText } = render(<ChooseCategoryBottomSheet {...defaultProps} />);
    ...
    it('renders category icons', () => {
      const { UNSAFE_getAllByType } = render(<ChooseCategoryBottomSheet {...defaultProps} />);
    ...
    it('highlights selected category', () => {
      const { UNSAFE_getAllByType } = render(
        <ChooseCategoryBottomSheet {...defaultProps} selectedCategoryId="adventure" />
      );
  ...
  describe('User Interactions', () => {
    ...
    it('calls onClose when modal requests to close', () => {
      const { UNSAFE_getByType } = render(<ChooseCategoryBottomSheet {...defaultProps} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('renders correctly with pre-selected category', () => {
      const { getByText } = render(
        <ChooseCategoryBottomSheet {...defaultProps} selectedCategoryId="culture" />
      );
