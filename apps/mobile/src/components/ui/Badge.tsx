/**
 * Badge - Lovendo Ultimate Design System 2026
 ...
 * ```tsx
 * // Label badge
 * <Badge type="label" variant="success" label="Active" />
 *
 * // Status badge with pulse
 * <Badge type="status" variant="error" label="LIVE" pulse showDot />
 *
 * // Trust badge
 * <Badge type="trust" trustScore={85} />
 *
 * // Notification count
...
export type BadgeType = 'label' | 'status' | 'trust' | 'notification';
...
/** @deprecated Use Badge with type="status" variant="error" pulse showDot */
...
/** @deprecated Use Badge with type="status" variant="success" icon="check-decagram" */
...
/** @deprecated Use Badge with type="status" variant="premium" icon="crown" */
...
/** @deprecated Use Badge with type="notification" */
export const NotificationBadge: React.FC<{
  count: number;
  max?: number;
  style?: ViewStyle;
}> = ({ count, max, style }) => (
  <Badge type="notification" count={count} maxCount={max} style={style} />
);
