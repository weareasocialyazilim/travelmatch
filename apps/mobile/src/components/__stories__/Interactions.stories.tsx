...
export const FormInputs: StoryObj = {
  render: () => <FormInputsComponent />,
};

// Toggle states example
const ToggleStatesComponent = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.sliderGroup}>
        ...
        <TextInput
          ...
          onChangeText={(value) => setMaxPrice(Number(value) || 0)}
        />
      </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        ...
        <AnimatedButton
          onPress={() =>
            step < 4 ? setStep((s) => s + 1) : console.log('Submit:', formData)
          }
          disabled={!canProceed()}
        >
          <View style={styles.button}>
