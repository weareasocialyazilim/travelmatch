  ...
  return (
    <View style={{ backgroundColor: '#dc2626', paddingVertical: 10, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
        <View style={{ width: 18, height: 18, backgroundColor: '#fff', borderRadius: 9 }}>
          <View style={{ position: 'absolute', width: 14, height: 2, backgroundColor: '#dc2626', top: 8, left: 2, transform: [{ rotate: '45deg' }] }} />
          <View style={{ position: 'absolute', width: 14, height: 2, backgroundColor: '#dc2626', top: 8, left: 2, transform: [{ rotate: '-45deg' }] }} />
        </View>
      ...
      {props.showRetry !== false && (
        <View style={{ backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 }}>
          <View style={{ color: '#fff', fontSize: 13, fontWeight: '600' }}>Retry</View>
        </View>
      )}
    </View>
  );
