  ...
  public: {
    Tables: {
      ...
      active_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "active_alerts_acknowledged_by_fkey"
          ...
          {
            foreignKeyName: "active_alerts_resolved_by_fkey"
            columns: ["resolved_by"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      app_config: {
        Row: {
          ai_bot_semantic_layer: Json | null
          created_at: string | null
          current_site_vibe: string | null
          dynamic_seo_keywords: string[] | null
          id: string
          is_maintenance: boolean | null
          last_trend_sync: string | null
          maintenance_message: string | null
          min_version: string
          platform: string
          posthog_intent_metrics: Json | null
          trend_injection_log: Json | null
      ...
      coin_balance_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "coin_balance_history_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "public_profiles"
            referencedColumns: ["id"]
      ...
      commission_ledger: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["escrow_id"]
            isOneToOne: false
            referencedRelation: "view_admin_escrow_transactions"
            referencedColumns: ["id"]
          },
          {
          ...
          },
          {
            ...
            columns: ["moment_id"]
            isOneToOne: false
            referencedRelation: "view_moderation_queue"
            referencedColumns: ["moment_id"]
          },
          {
      ...
      creator_drops: {
        ...
        Relationships: [
          {
            foreignKeyName: "creator_drops_creator_id_fkey"
            columns: ["creator_id"]
            isOneToOne: false
            referencedRelation: "public_profiles"
            referencedColumns: ["id"]
      ...
      disputes: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["transaction_id"]
            isOneToOne: false
            referencedRelation: "view_admin_finance_transactions"
            referencedColumns: ["id"]
          },
        ]
      }
      drop_moment_templates: {
        Row: {
          created_at: string | null
          description: string | null
          drop_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "drop_moment_templates_drop_id_fkey"
            columns: ["drop_id"]
            isOneToOne: false
            referencedRelation: "creator_drops"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      inbound_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "inbound_settings_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: true
            referencedRelation: "public_profiles"
            referencedColumns: ["id"]
      ...
      internal_error_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "internal_error_log_admin_id_fkey"
            columns: ["admin_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      messages: {
        Row: {
          ...
          type: string | null
          visibility:
            | Database["public"]["Enums"]["message_visibility_type"]
            | null
        }
        Insert: {
          content: string
      ...
      moments: {
        Row: {
          ai_moderation_labels: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "fk_moment_currency"
            columns: ["currency"]
            isOneToOne: false
            referencedRelation: "currencies"
            referencedColumns: ["code"]
      ...
      offer_requests: {
        Row: {
          ...
          message: string | null
          metadata: Json | null
          moment_template_id: string | null
          receiver_id: string
          sender_id: string
          status: string
          updated_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "offer_requests_drop_id_fkey"
            columns: ["drop_id"]
            isOneToOne: false
            referencedRelation: "creator_drops"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "offer_requests_moment_template_id_fkey"
            columns: ["moment_template_id"]
            isOneToOne: false
            referencedRelation: "drop_moment_templates"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "offer_requests_receiver_id_fkey"
            columns: ["receiver_id"]
            isOneToOne: false
            referencedRelation: "public_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "offer_requests_sender_id_fkey"
            columns: ["sender_id"]
            isOneToOne: false
            referencedRelation: "public_profiles"
            referencedColumns: ["id"]
      ...
      reports: {
        Row: {
          ...
          description: string | null
          id: string
          priority: Database["public"]["Enums"]["fraud_case_priority"]
          reason: string
      ...
      transactions: {
        Row: {
          ...
          type: string
          user_id: string
          withdrawal_approval_status: string | null
        }
        Insert: {
          amount: number
          created_at?: string | null
      ...
      triage_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "triage_items_assigned_to_fkey"
            columns: ["assigned_to"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "triage_items_resolved_by_fkey"
            columns: ["resolved_by"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      user_safety: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_safety_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "public_profiles"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      view_admin_escrow_transactions: {
        Row: {
          amount: number | null
          created_at: string | null
          currency: string | null
      ...
      view_admin_finance_transactions: {
        Row: {
          amount: number | null
          created_at: string | null
          currency: string | null
      ...
      view_financial_health: {
        Row: {
          active_escrow_balance: number | null
          last_updated: string | null
    ...
    Functions: {
      ...
      accept_offer_request: { Args: { p_request_id: string }; Returns: boolean }
      ...
      admin_finance_summary: {
        Args: { p_start: string; p_type?: string }
        Returns: {
      ...
      approve_gift_chat: {
        Args: { p_gift_id: string; p_receiver_id: string }
        Returns: Json
      }
      ...
      assign_vip_status: { Args: { p_user_id: string }; Returns: undefined }
      atomic_transfer: {
        Args: {
          p_amount: number
          p_message?: string
      ...
      check_abuse_risks: { Args: never; Returns: undefined }
      ...
      check_trigger_dm_uniques: {
        Args: { p_hours?: number; p_sender_id: string; p_threshold?: number }
        Returns: boolean
      }
      check_trigger_invite_abuse: {
        Args: { p_creator_id: string; p_minutes?: number; p_threshold?: number }
        Returns: boolean
      }
      check_trigger_message_burst: {
        Args: { p_minutes?: number; p_sender_id: string; p_threshold?: number }
        Returns: boolean
      }
      check_trigger_profile_scrape: {
        Args: { p_minutes?: number; p_threshold?: number; p_viewer_id: string }
        Returns: boolean
      }
      check_trigger_repeat_message: {
        Args: {
      ...
      decay_user_risk_scores: { Args: never; Returns: undefined }
      ...
      get_financial_config: { Args: { p_config_key: string }; Returns: Json }
      ...
      get_my_wallet_balance: { Args: never; Returns: Json }
      ...
      get_withdrawal_approval_threshold: { Args: never; Returns: number }
      ...
      is_user_safe: { Args: { p_user_id: string }; Returns: boolean }
      log_email_event: {
        Args: {
          p_event_data?: Json
          p_event_type: string
      ...
      process_expired_stories: { Args: never; Returns: number }
      record_consent: {
        Args: {
          consent_type: string
          consented: boolean
      ...
      sanitize_storage_path: { Args: { p_path: string }; Returns: string }
      ...
      soft_delete_account: { Args: { p_user_id: string }; Returns: boolean }
      ...
      toggle_vip_status: {
        Args: { enable_vip: boolean; target_user_id: string }
        Returns: Json
      }
      transfer_funds:
        | {
    ...
    Enums: {
      ...
      dispute_status:
        ...
        | "cancelled"
        | "expired"
      fraud_case_priority: "low" | "medium" | "high" | "critical"
      fraud_case_status: "open" | "investigating" | "resolved" | "escalated"
      fraud_case_type:
        | "payment_fraud"
        | "identity_theft"
        | "account_takeover"
      ...
      fraud_evidence_type:
        ...
        | "document"
        | "ip_log"
      linked_account_connection:
        | "same_ip"
        | "same_device"
        | "same_payment"
        | "same_phone"
        | "behavioral"
      message_visibility_type: "public" | "ghost"
      ...
      user_account_type:
        ...
        | "partner"
        | "exempt"
      vip_status: "active" | "inactive" | "pending" | "expired"
      vip_tier: "vip" | "influencer" | "partner"
      wallet_transaction_type: "credit" | "debit" | "adjustment"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
