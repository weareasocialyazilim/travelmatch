...
export const PRIORITY_COLORS: Record<string, string> = {
  urgent: 'text-red-500 bg-red-500/10 border-red-500/30 dark:text-red-400 dark:bg-red-500/20 dark:border-red-500/30',
  ...
  medium: 'text-yellow-500 bg-yellow-500/10 border-yellow-500/30 dark:text-yellow-400 dark:bg-yellow-500/20 dark:border-yellow-500/30',
...
export const STATUS_COLORS: Record<string, string> = {
  active: 'text-green-700 bg-green-100 dark:text-green-400 dark:bg-green-500/20',
  pending: 'text-yellow-700 bg-yellow-100 dark:text-yellow-400 dark:bg-yellow-500/20',
  suspended: 'text-orange-700 bg-orange-100 dark:text-orange-400 dark:bg-orange-500/20',
...
export const CREATOR_TIER_COLORS: Record<string, string> = {
  bronze: 'text-orange-700 bg-orange-100 dark:text-orange-400 dark:bg-orange-500/20',
  ...
  platinum: 'text-purple-700 bg-purple-100 dark:text-purple-400 dark:bg-purple-500/20',
};
...
export const BADGE_RARITY_COLORS: Record<string, string> = {
  ...
  legendary: 'text-yellow-700 bg-yellow-100 dark:text-yellow-400 dark:bg-yellow-500/20',
};
