...
const navigationItems: NavCommandItem[] = [
  { id: 'queue', title: 'İş Kuyruğu', icon: ListTodo, href: '/queue', shortcut: '⌘1' },
  { id: 'dashboard', title: 'Dashboard', icon: LayoutDashboard, href: '/dashboard', shortcut: '⌘D' },
  { id: 'users', title: 'Kullanıcılar', icon: Users, href: '/users', shortcut: '⌘U' },
  { id: 'moments', title: 'Momentler', icon: Image, href: '/moments' },
  { id: 'disputes', title: 'Anlaşmazlıklar', icon: AlertTriangle, href: '/disputes' },
  { id: 'finance', title: 'Finans', icon: DollarSign, href: '/finance', shortcut: '⌘F' },
  { id: 'analytics', title: 'Analitik', icon: BarChart3, href: '/analytics', shortcut: '⌘A' },
  { id: 'revenue', title: 'Gelir', icon: TrendingUp, href: '/revenue' },
  { id: 'geographic', title: 'Coğrafi Analiz', icon: Globe, href: '/geographic' },
  { id: 'wallet-operations', title: 'Cüzdan İşlemleri', icon: Wallet, href: '/wallet-operations' },
  ...
  { id: 'creators', title: 'İçerik Üreticileri', icon: Award, href: '/creators' },
  { id: 'moderation', title: 'Moderasyon', icon: Shield, href: '/moderation' },
  { id: 'safety-hub', title: 'Güvenlik Merkezi', icon: Shield, href: '/safety-hub' },
  { id: 'compliance', title: 'Uyumluluk', icon: FileText, href: '/compliance' },
  { id: 'audit-trail', title: 'Denetim Kaydı', icon: Activity, href: '/audit-trail' },
  { id: 'feature-flags', title: 'Feature Flags', icon: Flag, href: '/feature-flags' },
  { id: 'ai-center', title: 'AI Merkezi', icon: Brain, href: '/ai-center' },
  { id: 'ai-insights', title: 'AI Insights', icon: Zap, href: '/ai-insights' },
  { id: 'command-center', title: 'Komuta Merkezi', icon: Activity, href: '/command-center' },
  { id: 'ceo-briefing', title: 'CEO Brifing', icon: BarChart3, href: '/ceo-briefing' },
  { id: 'team', title: 'Ekip', icon: Users, href: '/team' },
  { id: 'alerts', title: 'Uyarılar', icon: Bell, href: '/alerts' },
  { id: 'settings', title: 'Ayarlar', icon: Settings, href: '/settings', shortcut: '⌘,' },
];
