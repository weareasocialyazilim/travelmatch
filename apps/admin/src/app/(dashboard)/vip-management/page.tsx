...
function AddVIPDialog({ open, onOpenChange, onAdd, isLoading }: AddVIPDialogProps) {
  ...
  const { data: searchResults, isLoading: isSearching } = useSearchUsers(userSearch);
        ...
        <CanvaCardBody>
          ...
          {usersError && (
            <div className="mb-4 flex items-center gap-2 text-destructive">
              ...
              <span>{usersError.message || 'VIP kullanicilari yuklenirken bir hata olustu'}</span>
            </div>
          )}
