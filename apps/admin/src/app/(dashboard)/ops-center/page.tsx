    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-6">
        <CanvaStatCard
          ...
          change={{ value: realtimeMetrics.activeUsersChange }}
        ...
        <CanvaStatCard
          label="Eslesme/dk"
          value={realtimeMetrics.matchesPerMinute}
          icon={<Heart className="h-5 w-5 text-pink-600" />}
        />
        <CanvaStatCard
          label="Moment/dk"
          value={realtimeMetrics.momentsPerMinute}
          icon={<Camera className="h-5 w-5 text-purple-600" />}
        />
        <CanvaStatCard
          label="Odeme/dk"
          value={realtimeMetrics.paymentsPerMinute}
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          <CanvaCard>
            <CanvaCardHeader>
              <CanvaCardTitle>Sistem Sagligi</CanvaCardTitle>
              <CanvaCardSubtitle>Tum servisler calisiyor</CanvaCardSubtitle>
            </CanvaCardHeader>
          ...
          <CanvaCard>
            <CanvaCardHeader>
              <CanvaCardTitle>Kaynak Kullanimi</CanvaCardTitle>
            </CanvaCardHeader>
            <CanvaCardBody className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Bant Genisligi</span>
        ...
        <CanvaCard className="lg:col-span-2">
          <CanvaCardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CanvaCardTitle>Canli Aktivite</CanvaCardTitle>
                <CanvaCardSubtitle>
                  Gercek zamanli platform aktivitesi
                </CanvaCardSubtitle>
              </div>
              {isLive && (
