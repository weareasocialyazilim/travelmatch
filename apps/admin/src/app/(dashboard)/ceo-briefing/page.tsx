...
const founderDecisions = [
  {
    ...
    description: 'Ahmet K. (Premium) 48 saat içinde karar bekliyor. Fraud skoru düşük (%12), muhtemelen iletişim problemi.',
  ...
  },
  {
    ...
    description: 'Stripe %2.4 → %2.9 teklif etti. Alternatif: iyzico %2.2 (entegrasyon 2 hafta)',
    deadline: 'Yarın COB',
...
const systemHandled = [
  { type: 'proof', count: 47, label: 'Proof otomatik onaylandı', savings: '~4 saat manuel iş' },
  { type: 'kyc', count: 23, label: 'KYC auto-verified', savings: '~2 saat manuel iş' },
  { type: 'fraud', count: 3, label: 'Fraud attempt blocked', savings: '₺12K potansiyel kayıp önlendi' },
  { type: 'support', count: 156, label: 'Chatbot çözümledi', savings: '~8 saat destek' },
  { type: 'dispute', count: 8, label: 'Auto-resolved (düşük risk)', savings: '~1 saat' },
];
          ...
          <div className="grid grid-cols-3 gap-4">
              ...
              <CanvaCardBody className="space-y-3">
                {founderDecisions.length === 0 ? (
                  <div className="text-center py-4">
                    ...
                    <p className="text-sm text-muted-foreground">Temiz! Karar bekleyen yok.</p>
                  </div>
                ) : (
            ...
            <CanvaCard className="admin-card border-blue-500/30 bg-blue-500/5">
              <CanvaCardHeader className="pb-2">
                ...
                <CanvaCardSubtitle className="text-xs">Tek şeye odaklan</CanvaCardSubtitle>
              </CanvaCardHeader>
              <CanvaCardBody>
                <div className="space-y-3">
                  <div>
                    <p className="font-semibold text-blue-600 dark:text-blue-400">{founderFocus.title}</p>
                    <p className="text-xs text-muted-foreground mt-1">{founderFocus.why}</p>
                  </div>
                  ...
                  <div>
                    <p className="text-xs font-medium text-red-500 mb-1">Engelleyiciler:</p>
            ...
            <CanvaCard className="admin-card border-emerald-500/30 bg-emerald-500/5">
              <CanvaCardHeader className="pb-2">
                ...
                <CanvaCardSubtitle className="text-xs">Son 24 saat otomasyon</CanvaCardSubtitle>
              </CanvaCardHeader>
              <CanvaCardBody>
