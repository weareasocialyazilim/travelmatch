        ...
        switch (definition.source) {
          ...
          case 'security_logs': {
            ...
            if (conditions.event_status) {
              query = query.in('event_status', conditions.event_status as string[]);
            }
            if (conditions.risk_score_gte) {
              query = query.gte('risk_score', conditions.risk_score_gte as number);
            }
          ...
          case 'moderation_logs': {
            ...
            if (conditions.action_taken) {
              query = query.in('action_taken', conditions.action_taken as string[]);
            }
...
function generateShortDetail(key: string, count: number, lookbackHours: number): string {
