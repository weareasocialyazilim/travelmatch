  ...
  return useQuery<ResponseTimeItem[]>({
    ...
    queryFn: async () => {
      try {
        ...
        toast.error(
          'Yanit suresi verileri yuklenemedi, mock veri kullaniliyor',
        );
  ...
  return useQuery<HourlyMessageItem[]>({
    ...
    queryFn: async () => {
      try {
        ...
        toast.error(
          'Saatlik mesaj verileri yuklenemedi, mock veri kullaniliyor',
        );
  ...
  return useQuery<WeeklyTrendItem[]>({
    ...
    queryFn: async () => {
      try {
        ...
        toast.error(
          'Haftalik trend verileri yuklenemedi, mock veri kullaniliyor',
        );
