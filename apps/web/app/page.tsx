      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {pillars.map((pillar, index) => {
            const pillarContent =
              content.powerPillars[
                pillar.key as keyof typeof content.powerPillars
              ];
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${pillar.gradient} translate-x-3 translate-y-3 rounded-[24px] opacity-50`}
                />

                {/* Main Card */}
                <div
                  className={`relative bg-[#0a0a0a] border-2 ${pillar.borderColor} rounded-[24px] p-8 h-full transition-all duration-300 group-hover:border-white`}
                >
                  {/* Icon */}
                  ...
                  <div className="absolute top-6 right-6 w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center">
                    <span className="text-white/40 font-mono text-lg font-bold">
                      0{index + 1}
                    </span>
                  </div>
                  ...
                  <p
                    className={`text-sm font-mono tracking-widest mb-4 bg-gradient-to-r ${pillar.gradient} bg-clip-text text-transparent`}
                  >
