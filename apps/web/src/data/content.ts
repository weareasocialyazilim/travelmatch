...
export const TRANSLATIONS = {
  ...
  TR: {
    ...
    manifesto_txt:
      'DIJITAL OYALAMALAR, UZAYAN SOHBETLER, YARIM PLANLAR. BUNLARI ZATEN DENEDIK. LOVENDO, GERCEKTEN GELENLER ICIN. UZUN UZUN YAZISMAK YOK. GELIYORSAN GEL. GERISI KONUSULUR.',
    ...
    alt_success_title: 'VIZYONER UYARISI.',
    alt_success_sub: 'SECMEN BULUTTA.',
    alt_success_msg:
      'ONERIN BAYIK DEGILSE, EKRANINA DUSEBILEBILIR. DEGILSE, BU BIR DIGITAL BOSLUK. ALGORITMA KARAR VERIRKEN EGOYU DUSUK TUT.',
    alt_success_footer: 'BIR DAHAKINE BAYIK OLMA.',
    alt_success_btn: 'TAMAM PEKE',
  },
};
