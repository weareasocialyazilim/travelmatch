  ...
  return (
    <section className="relative h-[150vh] w-full bg-black flex items-center justify-center">
      ...
      <div className="relative z-10 text-center space-y-12">
        <h2 className="text-9xl font-black italic uppercase tracking-tighter mix-blend-difference">
          KANIT <br /> <span className="text-stroke">TÖRENİ</span>
        </h2>
        <div className="max-w-xl mx-auto glass-card p-8 rounded-[2rem] border-white/5 backdrop-blur-3xl">
          <p className="text-2xl font-bold italic leading-tight">
            "Sahte profillere yer yok. Herkes gerçek, her an kanıtlı."
          </p>
          <div className="mt-8 h-1 w-full bg-white/10 overflow-hidden rounded-full">
            <motion.div
              animate={{ x: ['-100%', '100%'] }}
