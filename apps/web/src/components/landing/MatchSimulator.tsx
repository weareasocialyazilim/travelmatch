      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="text-muted max-w-lg mx-auto mt-6 text-sm leading-relaxed">
            Our ML engine processes millions of data points to find your perfect
            moment. Select your interests and watch the magic happen.
          </p>
        </motion.div>
        ...
        {selectedInterests.length > 0 && !showResults && (
          ...
          >
            ...
            >
              {isLoading
                ? 'Analyzing...'
                : `Analyze ${selectedInterests.length} Interest${selectedInterests.length > 1 ? 's' : ''}`}
            </button>
          </motion.div>
        )}
...
function RecommendationCard({
  ...
  return (
    ...
    >
      {/* Type Badge */}
      <div
        className={`text-[9px] uppercase tracking-widest mb-3 ${typeColors[recommendation.type]}`}
      >
