  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'assistant',
      content: "Hey! I'm your Neural Nexus guide. What vibe are you chasing today?",
    },
  ]);
  ...
  const handleSend = async (vibeOrMessage: string) => {
    ...
    setTimeout(() => {
      const responses: Record<string, string> = {
        adrenaline: "Sick choice! I'm sensing you need something that gets your heart racing. Skydiving in Cappadocia or midnight motorsport in Dubai?",
        solitude: "I feel that. Sometimes you need to disappear. A silent retreat in Bali or stargazing in the Sahara hits different.",
        connection: "Real ones only! Let's find you a soul that matches your frequency. Cultural exchange in Tokyo or volunteer vibes in Costa Rica?",
        culture: "Cultured king/queen! Hidden art galleries in Paris or underground jazz in New Orleans await.",
      };

      const isVibe = Object.keys(responses).includes(vibeOrMessage.toLowerCase());
