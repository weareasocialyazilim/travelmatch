...
Founder Alert Routing, internal kaynaklardan alarm bilgisi çekerek Founder Pulse içinde görünürlük
sağlar.
...
export const FOUNDER_ALERTS_ENABLED = process.env.NEXT_PUBLIC_FOUNDER_ALERTS_ENABLED === 'true';
