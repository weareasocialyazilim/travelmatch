...
**Dosya:** `apps/mobile/src/features/discover/screens/EscrowStatusScreen.tsx` **Satir:** 47-72
...
**Dosya:** `apps/mobile/src/features/profile/screens/ProfileDetailScreen.tsx` **Satir:** 75-95
...
> **NOT:** Bu stabilization release'de SADECE crash fix'ler yapildi. Performance optimization
> gelecek sprint'e birakildi.
...
_Rapor Tarihi: 2026-01-14_ _Hazirlayan: Claude (Release Guardian)_
