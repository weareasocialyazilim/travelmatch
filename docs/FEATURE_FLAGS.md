...
**NOT:** Bu flag'lar UI'da "Mock Data" badge'i gostermek icin kullanilir. Gercek data baglantiginda
`false` yapilmalidir.
...
_Dokuman Tarihi: 2026-01-14_ _Hazirlayan: Claude (Release Guardian)_
